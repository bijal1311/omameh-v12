/**
 * Case 00 · article data.
 *
 * Front matter plus body. Copy is verbatim from
 * 07_CASE_00_EDITORIAL_source_of_truth.md — the same text publishes to
 * Substack and the two must not drift. Content is locked: if a string
 * looks wrong, raise it rather than correcting it here.
 *
...
export const publishedAt = '2026-09-03';
